...
test_that("lookup works as intended", {
  expect_identical(lookup_GEOID(state = "AL"), 1)
...
test_that("state pull works as intended", {
  expect_equal(dim(pull_state_ACAG(year = 2016, level = "National")), c(49, 3))
  expect_equal(dim(pull_state_ACAG(year = 2016, level = "State", state = c(1, 5, 4))), c(3, 3))
})
...
test_that("county pull works as intended", {
  ...
  expect_equal(dim(pull_county_ACAG(year = 2016, level = "State", state = c(1, 5, 4))), c(157, 4))
...
test_that("tract pull works as intended", {
  ...
  expect_equal(dim(pull_tract_ACAG(year = 2016, level = "State", state = c(1, 5, 4))), c(3391, 4))
